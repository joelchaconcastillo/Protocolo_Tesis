...
\newcommand{\mylanguage}{ngerman,american, spanish}
...
\newcommand{\myhead}{Protocolo de investigaci\'on de la T\'esis de Joel Chac\'on Castillo}
%% e.g., "" (empty), "disable", ...
...
%%%% Document metadata
%% ========================================================================
\newcommand{\myauthor}{Joel Chacón Castillo}  %% also used for PDF
%% general metadata:
\newcommand{\mynamecimat}{Centro de Investigación en Matemáticas, A. C.}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{Protocolo de investigación}% de la Tesis ''Importancia de la diversidad y criterio de parada en el diseño de optimizadores estocásticos``}  %% also used for PDF metadata (hyperref)
...
\sectionmark{\myhead}
\input{Propuestas_iniciales}

\section{Líneas de trabajo}
\sectionmark{\myhead}
\input{Lineas_de_trabajo_conclusiones}
\pagebreak
